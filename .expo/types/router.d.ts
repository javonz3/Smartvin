...
export namespace ExpoRouter {
  type StaticRoutes = `/alerts` | `/compare` | `/marketplace` | `/valuation` | `/_sitemap` | `/` | `/(tabs)` | `/analytics` | `/history` | `/more` | `/profile`;
  type DynamicRoutes<T extends string> = `/vehicle-details/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/vehicle-details/[id]`;
